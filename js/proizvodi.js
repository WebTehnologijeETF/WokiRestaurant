...
function validirajZaAzuriranje()
{
	return (validacijaIDa("idP")&& validacijaNaziva("nazivP")&& validacijaOpisa("opis") && validacijaUrla("urlSlike"));	
}

function validirajZaBrisanje()
{
	return validacijaIDa("idP");
}

function OcistiErrorPoruke()
{
	...
	prikaziPoruku(true,"", document.getElementById("IDError"));
	prikaziPoruku(true,"", document.getElementById("NazivError"));
	prikaziPoruku(true,"", document.getElementById("OpisError"));
	prikaziPoruku(true,"", document.getElementById("UrlError"));
}

function validacijaIDa(id1)
{
	var id= document.getElementById(id1);
	var idV= document.getElementById(id1).value;
